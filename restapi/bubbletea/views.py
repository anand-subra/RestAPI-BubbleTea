...
from restapi.bubbletea.permissions import IsOwnerOrReadOnly
from .models import Franchise, Drink, Review, Location
from restapi.bubbletea.serializers import FranchiseSerializer, DrinkSerializer, ReviewSerializer, LocationSerializer
